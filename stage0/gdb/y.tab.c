...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "PLUS", "MINUS",
  "MUL", "DIV", "'('", "')'", "$accept", "Program", "expr", YY_NULLPTR
};
...
yyreduce:
  ...
  case 2: /* Program: expr  */
#line 26 "parser.y"
                   {infixtoprefix((yyvsp[0].p));printf("\n");free((yyvsp[0].p));}
#line 1137 "y.tab.c"
    break;

  case 3: /* expr: expr PLUS expr  */
#line 29 "parser.y"
                        {(yyval.p) = createTree("+",(yyvsp[-2].p), (yyvsp[0].p));}
#line 1143 "y.tab.c"
    break;
