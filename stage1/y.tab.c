...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "END", "PLUS",
  "MINUS", "DIV", "MUL", "'('", "')'", "$accept", "program", "expr", YY_NULLPTR
};
...
{
       5,    10,    11,     6,     1,     0,    13,    14,    15,    16,
       2,     8,     9,    10,    11,     0,    12,     7,     8,     9,
      10,    11
};

static const yytype_int8 yycheck[] =
{
       2,     7,     8,     0,     3,    -1,     8,     9,    10,    11,
       9,     5,     6,     7,     8,    -1,    10,     4,     5,     6,
       7,     8
};
...
#line 20 "exprtree.y"
                  {(yyval.no)=(yyvsp[-1].no); printf("Answer: %d\n",evaluate((yyvsp[-1].no)));printf("Prefix: "); prefix((yyvsp[-1].no));printf("\n"); printf("Postfix: "); postfix((yyvsp[-1].no)); printf("\n"); exit(1);}
#line 1138 "y.tab.c"
    break;
